...
PROMPT_GEN_REASON_NO_QUESTION_PLUS = """지문:
{paragraph}
...
지문을 읽고 질문에 대한 단계별로 생각하며 답을 구하세요.
해설:"""

PROMPT_GEN_REASON_QUESTION_PLUS = """지문:
{paragraph}
...
PROMPT_W_REASON_NO_QUESTION_PLUS = """지문:
{paragraph}
...
PROMPT_W_REASON_QUESTION_PLUS = """지문:
{paragraph}
